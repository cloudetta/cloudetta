...
# ============================================================================
# Cloudetta Bootstrap Installer (versione completa)
...
# - Odoo: master password + crea DB con demo
...
# (non rompe i valori esistenti, li integra se mancano)
...
# === 1c) Assicura il secret Redmine PRIMA del primo avvio ====================
...
# 4c-bis) Odoo: master password + crea DB con demo (idempotente)
...
bundle exec rails runner "
  ...
  if u
    ...
    u.mail = ENV[\"ADMIN_EMAIL\"]; u.must_change_passwd = false; u.save!
...
- DokuWiki   → http://wiki.localhost   | BasicAuth (Caddy)
